  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glass-lg': '0 16px 40px -4px rgba(31, 38, 135, 0.1)',
        'card': '0 2px 8px -1px rgba(0, 0, 0, 0.03), 0 1px 4px -1px rgba(0, 0, 0, 0.02)',
        'card-hover': '0 12px 30px -10px rgba(59, 130, 246, 0.2)',
